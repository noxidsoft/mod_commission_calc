...
/**
 * @version      $Id$
 * @package      Commission Calculator - Euro
 * @subpackage   mod_commission_calc_euro
...
<link rel="stylesheet" href="<?php echo $baseUrl ?>/modules/mod_commission_calc_euro/css/template.css" type="text/css" />
<?php
	$document = &JFactory::getDocument();
	$document->addScript( $baseUrl.'/modules/mod_commission_calc_euro/js/ajax.js' );
?>
</head>
