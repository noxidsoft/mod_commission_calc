...
<link rel="stylesheet" href="<?php echo $baseUrl ?>/modules/mod_commission_calc_dollar/css/template.css" type="text/css" />
<?php
	$document = &JFactory::getDocument();
	$document->addScript( $baseUrl.'/modules/mod_commission_calc_dollar/js/ajax.js' );
?>
</head>
