...
<link rel="stylesheet" href="<?php echo $baseUrl ?>/modules/mod_commission_calc_pound/css/template.css" type="text/css" />
<?php
	$document = &JFactory::getDocument();
	$document->addScript( $baseUrl.'/modules/mod_commission_calc_pound/js/ajax.js' );
?>
</head>
